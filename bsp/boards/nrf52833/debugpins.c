...
void debugpins_init(void) {
    ...
    NRF_P0->DIRSET = 1<<(PIN_FRAME);
    NRF_P0->DIRSET = 1<<(PIN_SLOT);
    NRF_P0->DIRSET = 1<<(PIN_FSM);
    NRF_P0->DIRSET = 1<<(PIN_TASK);
    NRF_P0->DIRSET = 1<<(PIN_ISR);
    NRF_P0->DIRSET = 1<<(PIN_RADIO);
    NRF_P0->DIRSET = 1<<(PIN_ISRUART_TX);
    NRF_P0->DIRSET = 1<<(PIN_ISRUART_RX);
    NRF_P0->DIRSET = 1<<(PIN_INTDISABLED);
